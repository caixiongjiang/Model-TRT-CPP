...
class glm3():
    def __init__(self, modelName="chatglm3-6b") -> None:
        # 检查是否支持模型
        ...
        # 加载模型
        self.model =  AutoModelForCausalLM.from_pretrained(modelWeightPath, trust_remote_code=True).half() # 该模型支持的为fp16
    ...
    def chat(self, messages, max_length=None, top_p=None, temperature=None):
        # 调用模型进行对话生成
        history = []
